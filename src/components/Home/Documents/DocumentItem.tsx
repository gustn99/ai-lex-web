...
export default function DocumentItem({
	...
	const partyContent = party === 'plaiintiff' ? '피고측 입장' : '원고측 입장';
	...
	return (
		<a href={href} className="border-line-normal-neutral flex flex-col rounded-xl border p-3">
			<div className="mb-2 flex justify-between">
				<ContentBadge appearance="solid" color="blue" className="my-0.5">
					{partyContent}
				</ContentBadge>
			...
			<div className="mb-4 flex items-center gap-1">
				<span className="text-body-01-normal font-semibold">{title}</span>
				<div className="bg-line-normal-normal h-3 w-px" />
				<span className="text-label-01-normal text-label-neutral">{caseNumber}</span>
			</div>
